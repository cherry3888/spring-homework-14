...
public class Book {
    ...
    @OneToMany(targetEntity = ru.cherry.springhomework.h2.domain.Comment.class, orphanRemoval = true, fetch = FetchType.EAGER)
    @JoinColumn(name = "book_id")
    private List<ru.cherry.springhomework.h2.domain.Comment> comments;
